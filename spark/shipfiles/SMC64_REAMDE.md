...
Delete `smc64.dll` and `xaudio2_9redist.dll`, then rename `xaudio2_9redist.dll~` to `xaudio2_9redist.dll`.

## Usage

Start Halo MCC *without* Easy Anti-Cheat.

If the mod loaded correctly, it should say "SMC64 Loaded" in the main menu at the top.
