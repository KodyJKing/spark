...
HOOK( UpdatePlayerControlsAndLook, void, 0xA997B8U, float, uint32_t /*tickBudget*/ )
...
HOOK( SpawnObject, uint32_t, 0xB35FD4U, Engine::SpawnObjectArgs*, uint32_t /*flags*/, uint64_t, uint64_t )
