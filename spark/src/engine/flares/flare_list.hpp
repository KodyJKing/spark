...
namespace Engine {
    SPARK_API bool isFlareManagerLoaded();
    SPARK_API FlareManager* getFlareManager();
    SPARK_API FlareEntry* getFlareEntry( uint32_t flareHandle );
    ...
    SPARK_API void foreachFlareEntry( FlareEntryCallback cb, void* ctx );
