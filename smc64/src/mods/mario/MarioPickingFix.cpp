...
namespace HaloCE::Mod::Mario::MarioPickingFix {
    ...
    void registerHandlers(Spark::ModId modId) {
        Spark::TryPickInteractable::addHandler(modId, +[](void* /*ctx*/, Spark::TryPickInteractable::Cursor next, uint16_t p1, int16_t p2, uint32_t candidateEntityHandle, int16_t p4) {
